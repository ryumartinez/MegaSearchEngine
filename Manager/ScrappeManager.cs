...
) : IScrappeManager
{
    ...
    public async Task SearchAndSaveManyAsync(IEnumerable<string> searchTexts, CancellationToken ct = default)
    {
                     ...
                     .Distinct(StringComparer.OrdinalIgnoreCase))
        {
            ...
            await ScrappeSearchAndPersistAsync(term).ConfigureAwait(false);
        }
    }

    public async Task ScrappeSearchAndPersistAsync(string searchText)
    {

...
{
    public static IServiceCollection AddPlaywrightBrowserFactory(this IServiceCollection services)
    {
        ...
        services.AddSingleton<Task<IBrowser>>(sp =>
        {
            ...
            async Task<IBrowser> CreateBrowserAsync()
            {
                ...
                return await playwright.Chromium.ConnectAsync(wsEndpoint).ConfigureAwait(false);
            }
